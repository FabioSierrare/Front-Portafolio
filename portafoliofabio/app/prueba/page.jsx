  ...
  return (
    <div className="w-full h-screen p-5 flex justify-center items-center">
      <form
        ...
        className="max-w-2xl w-full flex flex-col bg-Abajo text-white rounded-2xl p-5"
      >
        ...
        <button
          type="submit"
          className="p-5 border border-white rounded-2xl w-1/3 mx-auto cursor-pointer hover:text-Abajo hover:border-transparent hover:bg-white"
        >
          Subir
        </button>
      </form>
