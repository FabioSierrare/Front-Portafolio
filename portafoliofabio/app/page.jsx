    ...
    <div className="w-full mx-auto p-5">
      ...
      <div className="w-full mt-13 flex">
        ...
        <div className="text-white flex-1 m-auto">
          ...
          <p className="p-2 mt-4 border w-70 text-center rounded-2xl text-xl">
            fabiosierra281@gmail.com
          </p>
        </div>
      </div>
      ...
      {/* Acerca de mi */}
      <div className="mt-13">
        <h2 className="text-4xl text-white mb-3 font-bold">ACERCA DE MI</h2>
        <p className="text-prf text-xl">
          Soy desarrollador de software con formación en Análisis y Desarrollo
          de Software. Tengo experiencia en la construcción de aplicaciones web
          utilizando tecnologías como C#, .NET y Next.js, participando tanto en
          el desarrollo backend como en la integración frontend.
          <br />
          <br />
          Me enfoco principalmente en la lógica de negocio, bases de datos y
          arquitectura de aplicaciones, buscando crear soluciones escalables y
          bien estructuradas.
          <br />
          <br />
          Me interesa seguir fortaleciendo mi perfil en desarrollo backend y
